...
def process_bydir(ori_img="", gt_mask="", predict_mask="", mask_contain_type=False, only_type=False, iou_threshold=0.05, iou_smaller_than=[0.5], iou_larger_than=[], extend_on=None, mask_ignore_threshold=0.0005, fp=False, merged=False, separate=False):
    label = {}
